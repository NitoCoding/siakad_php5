  ...
  <tr height="12">
    <td height="11" colspan="3" valign="top"><table width="900" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD023' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MP001' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD024' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD022' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD015' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD020' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD016' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
      ...
      <tr>
	   ...
	   <?
          ...
          $tpbk=mysql_fetch_array($pbk); 
		   ...
		   $tnils3=mysql_query("SELECT kd_eskul3 FROM tb_nilai_eskul WHERE thn_eskl='$thaj' AND sms_eskl='$sem' AND nis_eskl='$ct[nis]' AND 
		                       kls_eskl='$ct[kelas_st]'   ");
           $cnils3=mysql_fetch_array($tnils3);
		  
		  $pbk1=mysql_query("SELECT * FROM mata_pelajaran WHERE kd_mp='$cnils3[kd_eskul3]'  ");
          $tpbk1=mysql_fetch_array($pbk1);
