...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  ...
  ?>
      <tr>
        ...
        <td><div align="center">
            <?
   $tdth=mysql_query("SELECT * FROM tb_nilai_ext WHERE thn_ajar='$thaj' and semester='$sem' and bulan='$blnk' and kd_santri='$tp[nis]' and kelas='$klsk' ");
   $tdh=mysql_fetch_array($tdth);
   echo $tdh['izin'];
