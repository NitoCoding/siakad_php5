      ...
      <tr>
        ...
        <td><div align="center">
            <? 
				...
				// $tampi=mysql_query("SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MP006' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$kdklll[kd_kls]' ");
               //  $tpk3=mysql_fetch_array($tampi); $n_aqd=$tpk3['raport'];
	   ...
	   ?>
        ...
        <td bgcolor="#FFFFFF"><div align="center">
            <? $tampi=mysql_query("SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MD006' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$kdklll[kd_kls]' ");
                                     $tpk=mysql_fetch_array($tampi); 
        ...
        <td bgcolor="#FFFFFF"><div align="center">
            <? $tampi=mysql_query("SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MD007' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$kdklll[kd_kls]' ");
                                     $tpk=mysql_fetch_array($tampi); 
        ...
        <td valign="top" bgcolor="#FFFFFF"><div align="center">
          <? 
		  $tampi=mysql_query("SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MP019' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$kdklll[kd_kls]' ");
          $tpk=mysql_fetch_array($tampi);
		  $j24=$tpk['raport'];
		if($kkkm > $tpk['raport']){ echo "<font color='#FF0000'>$tpk[raport]</font>"; }else{ echo $tpk['raport']; }
		if($j24 >=1){ $tn24=1; }
        ...
        <td valign="top" bgcolor="#FFFFFF"><div align="center">
          <? 
		  $tampi=mysql_query("SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MP021' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$kdklll[kd_kls]' ");
          $tpk=mysql_fetch_array($tampi);
		  $j24=$tpk['raport'];
		if($kkkm > $tpk['raport']){ echo "<font color='#FF0000'>$tpk[raport]</font>"; }else{ echo $tpk['raport']; }
		if($j24 >=1){ $tn24=1; }
