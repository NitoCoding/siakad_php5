    ...
    <td colspan="3" valign="top"><?
	  ...
	  ?>
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bordercolor="#B3CF70">
		 ...
		 if($klsk!=""){
	$ntgs=mysql_query("SELECT * FROM  tb_catatan_wf WHERE nis='$tp[nis]' and kelas='$tp[kelas_st]' and semester='$sem' and thn_ajaran='$thaj' ");
		...
		?>
               <form id="form1" name="form1" method="post" action="page/act_nilai_santri.php">
			    <tr bgcolor="#FFFFCC">
				  ...
				  <?
				  $cw=mysql_query("SELECT * FROM tb_catatan_wf WHERE nis='$tp[nis]' and thn_ajaran='$thaj' and semester='$sem' and kelas='$klsk2' ");
