  ...
  <tr>
    <td valign="top"><table width="1670" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD015' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD022' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD020' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD023' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MP001' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD016' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD024' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD026' and kd='3' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD015' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD022' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD020' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD023' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MP001' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD016' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD024' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
        ...
        <td><div align="center">
          <?
		$npg=mysql_query("SELECT * FROM tb_raport_k13 WHERE id_santri='$cnt[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD026' and kd='4' ");
  		$cpg=mysql_fetch_array($npg);
