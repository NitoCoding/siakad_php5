...
<table width="1205" border="0" cellspacing="0" cellpadding="0">
  ...
  ?>
      <tr>
        ...
        <td><div align="center">
            <?
	$tdth=mysql_query("SELECT * FROM $tabelx,$tabelx2 WHERE $tabelx.nis_h='$tp[nis]' AND $tabelx.thn_ajrh='$thaj' AND $tabelx.sem_h='$sem' AND $tabelx.bln_h='$blnk' and $tabelx2.kd_hadir=$tabelx.id_hadir AND $tabelx2.kd_mpl='MP003' AND $tabelx2.status='I' ");
  ...
  ?>
        ...
        <td><div align="center">
            <?
   $tdth=mysql_query("SELECT * FROM $tabelx,$tabelx2 WHERE $tabelx.nis_h='$tp[nis]' AND $tabelx.thn_ajrh='$thaj' AND $tabelx.sem_h='$sem' AND $tabelx.bln_h='$blnk' and $tabelx2.kd_hadir=$tabelx.id_hadir AND $tabelx2.kd_mpl='MP003' AND $tabelx2.status='S' ");
   $tdh=mysql_num_rows($tdth);
   echo $tdh;
  ?>
        </div></td>
        <td><div align="center">
            <?
   $tdth=mysql_query("SELECT * FROM $tabelx,$tabelx2 WHERE $tabelx.nis_h='$tp[nis]' AND $tabelx.thn_ajrh='$thaj' AND $tabelx.sem_h='$sem' AND $tabelx.bln_h='$blnk' and $tabelx2.kd_hadir=$tabelx.id_hadir AND $tabelx2.kd_mpl='MP003' AND $tabelx2.status='A' ");
   $tdh=mysql_num_rows($tdth);
   echo $tdh;
  ?>
        </div></td>
