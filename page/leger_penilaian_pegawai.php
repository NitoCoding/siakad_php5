...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <? 
  $no=1;
  $tampi3=mysql_query("SELECT * FROM guru_pegawai WHERE unit='$tkt' ");
  ...
  <tr>
    ...
    <td bgcolor="#EEEEEE"><div align="center">
      <? 
	  $tamp2=mysql_query("SELECT * FROM tb_penilaian_bulanan_pegawai WHERE id_guru='$idgp' and thn_ajaran='$thaj' and bulan='$qbln' ");
