  ...
  <tr>
    <td height="667"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        ...
        <td><div align="center">
          <?    	       
	      $tampi3=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MP006' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
      ...
      <tr>
        <td><div align="center">
		 ...
		 $tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD023' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
		 ...
		 $tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD023' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD023' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
        <td><div align="center">
		 ...
		 $tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD017' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
		 ...
		 $tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD017' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD017' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
        <td><div align="center">
		 ...
		 $tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD019' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
          <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD019' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MP014' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
          <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MP014' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MP001' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MP001' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD026' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD026' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD026' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD024' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD024' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD024' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD022' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
        $tpk2=mysql_fetch_array($tampi2);  
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD022' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD022' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD015' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD015' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD015' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD020' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD020' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD020' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD016' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
		...
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MD016' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MD016' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MP005' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
        <td><div align="center">
          <?    	       
		/* $tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MP013' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		$tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='4' AND mapel='MP013' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk3=mysql_fetch_array($tampi2);  
        ...
        <td><div align="center">
            <?    	       
		   $tampi=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MP013' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk1=mysql_fetch_array($tampi);
      ...
      <tr>
		...
		/* $tampi2=mysql_query("SELECT * FROM tb_komptensi_inti WHERE kd_kompetensi='3' AND mapel='MP011' and kelas='$cmkl[kd_kls]' and tahun_ajaran='$thaj' and semester='$sem' ");
          $tpk2=mysql_fetch_array($tampi2);  
